	...
	<div class="container my-5 border-bottom">
		...
		<div class="profile">
			...
			<div class="profile-bio">
				...
				<p><span class="profile-real-name"><?php echo $_SESSION['fname_search']." ".$_SESSION['lname_search']; ?></span> Lorem ipsum dolor sit, amet consectetur adipisicing elit 📷✈️🏕️</p>
